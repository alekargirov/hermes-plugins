...
TOOLS = [
    ...
    (
        ...
        "carb, protein, fat or kcal. value is a whole number 1-999, or null to clear the ceiling — "
        "a cleared ceiling means the food grid shows a plain sum. A value outside 1-999 is REFUSED, "
        "never clamped — if they said 5000, ask; do not shrink it to fit.",
        _schema(
            {
                "field": _s("One of: carb, protein, fat, kcal"),
                "value": _n("Whole number 1-999 (grams, or kcal for kcal), or null to clear the ceiling"),
            },
            ["field"],
        ),
    ),
